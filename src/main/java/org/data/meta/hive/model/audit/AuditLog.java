...
public class AuditLog {
    ...
    private SchemaType newSchemaType;

    private String oldSchemaName;
    private SchemaType oldschemaType;
    ...
    public AuditLog(String operation, String user, List<String> groups, String oldSchemaName , SchemaType oldschemaType, String newSchemaName, SchemaType newSchemaType ) {
        this.operation = operation;
        this.user = user;
        this.groups = groups;
    ...
    public AuditLog(String operation, String user, List<String> groups, String oldSchemaName , SchemaType oldschemaType) {
        this.operation = operation;
        this.user = user;
        this.groups = groups;
        this.oldSchemaName = oldSchemaName;
    ...
    public AuditLog(String operation, String user, List<String> groups, String oldDb , String db) {
        this.operation = operation;
        this.user = user;
        this.groups = groups;
        this.oldDb = oldDb;
    ...
    public SchemaType getNewSchemaType() {
        return newSchemaType;
    }

    public void setNewSchemaType(SchemaType newSchemaType) {
        this.newSchemaType = newSchemaType;
    }

    public SchemaType getOldschemaType() {
        return oldschemaType;
    }

    public void setOldschemaType(SchemaType oldschemaType) {
        this.oldschemaType = oldschemaType;
    }
}
